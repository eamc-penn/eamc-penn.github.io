...
1. **Define** anonymity and **describe** the techniques that can be used to anonymize patient medical data.
...
Let's take a look at the official list of [HIPAA-protected attributes](https://cphs.berkeley.edu/hipaa/hipaa18.html) from the Health and Human Services Department:

1. Names;
2. All geographical subdivisions smaller than a state (e.g., street address, city, county, precinct, ZIP code except for the initial three digits of a ZIP code).[^1]
3. All dates (except year) directly related to an individual (e.g., birth date, admission date, exact ages in years over the ages of 90).[^2]
...
[^1]: The initial three digits of a zip code is still considered PHI by HIPAA if the number of individuals residing in all zip codes with those initial three digits is less than 20,000. Why do you think this is the case? How do you think the cutoff of 20,000 individuals was determined?
[^2]: Why are ages over 90 years-old considered PHI, but not younger ages?
...
Separately during your lunch break, you hear on the news that a famous celebrity - a 50 year-old female (in this hypothetical situation) - was recently admitted to HUP last week for a hypertensive crisis, and was just recently discharged from the hospital.[^3]

[^3]: In case it wasn't already clear, this dataset and scenario is entirely fictional, and was actually generated using [ChatGPT](https://chatgpt.com)! You can take a look at the generation process [here](https://chatgpt.com/share/f48b4e45-e6f0-4b68-a982-3c288ab27f94) if you're interested.
...
It turns out that a very similar re-identification strategy was used by [Dr. Latanya Sweeney](https://latanyasweeney.org/index.html) in 1997 where she successfully re-identified the then Governor of Massachusetts using publicly accessible, anonymized medical records released by the state of Massachusetts.[^4]

[^4]: Sweeney is an excellent writer and we encourage you to check out two of her publications on this topic: [1] Sweeney L. Only you, your doctor, and many others may know. Tech Sci. (2015). [Link to article](https://techscience.org/a/2015092903); [2] Sweeney L. $k$-Anonymity: A model for protecting privacy. Int J Uncertainty, Fuzziness, and Knowledge-based Systems 10(5): 557-70. (2002). [Link to article](https://epic.org/wp-content/uploads/privacy/reidentification/Sweeney_Article.pdf)
...
2. The *reason* why anonymization fails is that it assumes there are no other datasets or sources of information in the world to cross-reference.
:::
...
1. **Overview Article**: *All of Us* Research Program Overview. National Institutes of Health. Accessed 19 May 2024. [Link to article](https://allofus.nih.gov/about/program-overview)[^5]

[^5]: There's a great 2-minute intro video to the *All of Us* Research program [here](https://youtu.be/ti50nS7B5vI?si=UzV3skolOuFync9g).

2. **<u>Yes</u>, the anonymization achieved by the All-of-Us dataset is sufficient**: Xia W, Basford M, Carroll R, Clayton EW, Harris P, Kantacioglu M, Liu Y, Nyemba S, Vorobeychik Y, Wan Z, Malin BA. Managing re-identification risks while providing access to the *All of Us* research program. J Am Med Inf Assoc 30(5): 907-14. (2023). doi: [10.1093/jamia/ocad021](https://doi.org/10.1093/jamia/ocad021). PMID: 36809550

3. **<u>No</u>, the All-of-Us dataset hurts people of color**: Kaiser J. Million-person U.S. study of genes and health stumbles over including Native American groups. Science. (2019). [Link to article](https://www.science.org/content/article/million-person-us-study-genes-and-health-stumbles-over-including-native-american-groups)

::: column-margin
{{< fa lightbulb >}} There are other problems involving the All of Us research program, including a recent study [inadvertently using "objective" mathematical techniques that inappropriately validates racist and xenophobic ideologies](https://www.statnews.com/2024/03/15/all-of-us-genomic-sequencing-results-umap-science-history-sociology/).[^6] Even well-established data analysis techniques must be used and presented carefully!
:::

[^6]: The All of Us Research Program Genomics Investigators. Genomic data in the All of Us research program. Nature 627: 340-6. (2024). doi: [10.1038/s41586-023-06957-x](https://www.nature.com/articles/s41586-023-06957-x). PMID: 38374255
